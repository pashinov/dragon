//
// Created by apashinov on 7/09/19
//
...
LogHandle LOGGER(const std::string& name, spdlog::level::level_enum level = spdlog::level::info, const std::string& filename = std::string());
